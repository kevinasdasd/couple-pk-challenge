...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-blue-50 pb-6">
      {/* Header */}
      ...
      <div className="px-6 pt-3 pb-6 text-center">
        <motion.div
          ...
          className="mb-3"
        >
          <div className="inline-block bg-gradient-to-r from-orange-400 to-orange-500 text-white px-6 py-2 rounded-full text-sm font-medium shadow-lg mb-3">
            D&K专属小游戏
          </div>
